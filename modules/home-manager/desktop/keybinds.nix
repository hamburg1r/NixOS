    ...
    desktop = {
      ...
      keybinds = {
        ...
        screenshot = mkOption {
          default = [["Shift"] ["g"]];
          type = types.listOf types.raw;
          description = "key used to take a screenshot of a selection, format: [ [\"modifier1\", ...], [\"key\"] ]";
        };
        fullscreen-screenshot = mkOption {
          default = [["Control"] ["g"]];
          type = types.listOf types.raw;
          description = "key used to take a full-screen screenshot, format: [ [\"modifier1\", ...], [\"key\"] ]";
        };
        window-screenshot = mkOption {
          default = [["Alt"] ["g"]];
          type = types.listOf types.raw;
          description = "key used to take a screenshot of the focused window, format: [ [\"modifier1\", ...], [\"key\"] ]";
        };
        ...
        set-dynamic-cast-window = mkOption {
          default = [["Control"] ["p"]];
          type = types.listOf types.raw;
          description = "key used to set the dynamic cast target to the focused window, format: [ [\"modifier1\", ...], [\"key\"] ]";
        };
        set-dynamic-cast-monitor = mkOption {
          default = [["Alt"] ["p"]];
          type = types.listOf types.raw;
          description = "key used to set the dynamic cast target to the focused monitor, format: [ [\"modifier1\", ...], [\"key\"] ]";
        };
        clear-dynamic-cast-target = mkOption {
          default = [["Shift"] ["p"]];
          type = types.listOf types.raw;
          description = "key used to clear the dynamic cast target, format: [ [\"modifier1\", ...], [\"key\"] ]";
        };
        stop-cast = mkOption {
          default = [["Control" "Shift"] ["p"]];
          type = types.listOf types.raw;
          description = "key used to stop a PipeWire screencast, format: [ [\"modifier1\", ...], [\"key\"] ]";
        };
        no-mod = {
